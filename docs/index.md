...
### For Users
- [User Guide](60-user-guide.md) - How to use the system
- [Mac App Guide](README-MAC-APP.md) - macOS native menu bar app

### For Understanding
- [Vision & Principles](00-vision-and-principles.md) - Philosophy and core rules
- [Elevator Pitch](ELEVATOR-PITCH.md) - What this is and why it exists
- [Core Concepts](02-core-concepts-and-language.md) - Key terminology

### For Development
- [Build Guidance](10-build-guidance-prompt.md) - How to work on this codebase
- [Agent Development Guide](91-agent-development-guide.md) - Building intelligence agents
- [Build Log](99-build-log.md) - What was built and how

### For Deployment
- [Deployment Guide](50-deployment.md) - Production deployment options
- [MVP Architecture](11-mvp-architecture.md) - Technical architecture
...
- Read the [User Guide](60-user-guide.md)
- Check the [Build Log](99-build-log.md) for how things work
- Review [Vision & Principles](00-vision-and-principles.md) to understand the philosophy
